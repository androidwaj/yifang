...
/**
 * HTTP 请求类，用于管理通用�?HTTP 请求、图片上传下载等�? * TODO：（To be design...�? * 
 * @author SINA
 * @since 2013-11-05
 */
public class HttpManager {
    ...
    /**
     * 根据 URL 异步请求数据�?     * 
     * @param url    请求的地�?     * @param method "GET" or "POST"
     * @param params 存放参数的容�?     * @param file   文件路径，如�?是发送带有照片的微博的话，此参数为图片在 SdCard 里的绝对路径
     * 
     * @return 返回响应结果
...
//                throw new WeiboHttpException(result, statusCode);
    ...
    /**
     * 由于发私信和发微博对 formdata name="pic" 还是 name="file" 要求不一致，�?��提供�?��新的接口�?     * 
     * @param url    请求的地�?     * @param method "GET" or "POST"
     * @param params 存放参数的容�?     * @param file   文件路径，如果是发�?带有照片的微博的话，此参数为图片�?SdCard 里的绝对路径
     * 
     * @return 返回响应结果
     * @throws WeiboException 如果发生错误，则以该异常抛出
     */
...
//                throw new WeiboHttpException(result, statusCode);
    ...
    /**
     * 根据 URL 异步请求数据�?     * 
     * @param context 应用程序上下�?     * @param url     请求的地�?     * @param method  "GET" or "POST"
     * @param params  存放参数的容�?     * @param file    文件路径，如果是发�?带有照片的微博的话，此参数为图片�?SdCard 里的绝对路径
     * 
     * @return 返回响应结果
     * @throws WeiboException 如果发生错误，则以该异常抛出
